...
be on a single line. (The Klipper API server does not have a newline
requirement.)

The examples in this document will use the "whconsole" format (newline
terminated JSON commands) instead of the underlying API format (0x03
